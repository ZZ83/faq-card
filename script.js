    ...
    question.addEventListener( 'click', () => {
        if(question .lastElementChild.classList.contains("hide-answer")) {
            answers.forEach( answer => {
                ...
                answer.parentNode.firstElementChild.lastElementChild.style.transform = "rotate(0deg)";
            });
            ...
            question.firstElementChild.lastElementChild.style.transform = "rotate(180deg)";
            ...
            question.firstElementChild.lastElementChild.style.transform = "rotate(0deg)";
        }
    });
});